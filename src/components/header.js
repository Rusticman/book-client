  ...
  const  {confirmationOpacity, signedUpMessageOpacity} = this.props;
    return (
      <div id="header">
        ...
        <div id="signUpMessage" className={signedUpMessageOpacity}> Login first.<br/> Go to your profile page to update your account before selecting<br/>books you'd like to exchange.</div>
